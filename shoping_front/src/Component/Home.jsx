...
import { getProducts, clearErrors } from '../redux/action/productAct';
// import 
                         ...
                         <section id="products" className="mt-5">
                              <div className="row">
                                   {products && products.map((product, index) => (
                                        <Products product={product} loading={loading} key={product._id} />
                                   ))}
                              </div>
                         </section >
                         {resPerPage <= pageDataLen && (
                              ...
                              <div className="d-flex justify-content-center mt-5">
                                   <Pagination
                                        ...
                                        totalItemsCount={totalProductCount ? totalProductCount : 0}
